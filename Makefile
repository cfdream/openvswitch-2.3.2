...
bin_PROGRAMS = utilities/ovs-appctl$(EXEEXT) \
	...
	vtep/vtep-ctl$(EXEEXT) ovn/ovn-nbctl$(EXEEXT) \
...
DIST_COMMON = $(srcdir)/manpages.mk \
	...
	$(srcdir)/ovn/utilities/automake.mk $(srcdir)/Makefile.in \
...
am__append_41 = $(TESTPKI_FILES)
am__append_42 = $(TESTPKI_FILES) tests/ovs-pki.log
am__append_43 = clean-pki
am__append_44 = .h .hstamp
am__append_45 = $(HSTAMP_FILES)
am__append_46 = $(HSTAMP_FILES)
#am__append_47 = vswitchd/vswitch.gv vswitchd/vswitch.pic
#am__append_48 = vtep/vtep.gv vtep/vtep.pic
#am__append_49 = ovn/ovn-sb.gv ovn/ovn-sb.pic
#am__append_50 = ovn/ovn-nb.gv ovn/ovn-nb.pic
subdir = .
...
am__lib_libopenvswitch_la_SOURCES_DIST = lib/aes128.c lib/aes128.h \
	...
	lib/timeval.c lib/timeval.h lib/tnl-arp-cache.c \
	lib/tnl-arp-cache.h lib/tnl-ports.c lib/tnl-ports.h \
	...
	lib/vswitch-idl.c lib/vswitch-idl.h lib/lldp/aa-structs.h \
	lib/lldp/lldp.c lib/lldp/lldp-const.h lib/lldp/lldp-tlv.h \
	lib/lldp/lldpd.c lib/lldp/lldpd.h lib/lldp/lldpd-structs.c \
	lib/lldp/lldpd-structs.h lib/cm/data_warehouse.h \
	lib/cm/data_warehouse.c lib/cm/interval_rotator.h \
	lib/cm/interval_rotator.c \
	lib/cm/mt_hashtable_kFlowSrc_vInt_fixSize.h \
	lib/cm/mt_hashtable_kFlowSrc_vInt_fixSize.c \
	lib/cm/packet_processor.h lib/cm/packet_processor.c \
	lib/cm/global_data.h lib/cm/global_setting.h \
	lib/cm/cm_output.h lib/cm/cm_output.c \
	lib/cm/condition_rotator.h lib/cm/condition_rotator.c \
	...
	lib/dpif-netlink.h lib/netdev-linux.c lib/netdev-linux.h \
	lib/netlink-notifier.c lib/netlink-notifier.h \
	lib/netlink-protocol.h lib/netlink-socket.c \
	lib/netlink-socket.h lib/ovs-numa.c lib/ovs-numa.h \
	lib/rtnetlink-link.c lib/rtnetlink-link.h lib/route-table.c \
	lib/route-table.h lib/netdev-dpdk.c lib/netdev-dpdk.h \
...
am__objects_2 = lib/daemon-unix.lo lib/latch-unix.lo \
	...
	lib/stream-unix.lo
am__objects_3 = lib/dpif-netlink.lo lib/netdev-linux.lo \
	lib/netlink-notifier.lo lib/netlink-socket.lo \
	lib/ovs-numa.lo lib/rtnetlink-link.lo \
	lib/route-table.lo
...
am_lib_libopenvswitch_la_OBJECTS = lib/aes128.lo lib/backtrace.lo \
	...
	lib/syslog-libc.lo lib/table.lo lib/tag.lo lib/timer.lo \
	lib/timeval.lo lib/tnl-arp-cache.lo lib/tnl-ports.lo \
	lib/token-bucket.lo lib/tun-metadata.lo lib/unicode.lo \
	lib/unixctl.lo lib/util.lo lib/uuid.lo lib/vconn-stream.lo \
	lib/vconn.lo lib/vlan-bitmap.lo lib/vlandev.lo lib/vlog.lo \
	lib/vswitch-idl.lo lib/lldp/lldp.lo lib/lldp/lldpd.lo \
	lib/lldp/lldpd-structs.lo lib/cm/data_warehouse.lo \
	lib/cm/interval_rotator.lo \
	lib/cm/mt_hashtable_kFlowSrc_vInt_fixSize.lo \
	lib/cm/packet_processor.lo lib/cm/cm_output.lo \
	lib/cm/condition_rotator.lo $(am__objects_1) $(am__objects_2) \
...
am_ovn_lib_libovn_la_OBJECTS = ovn/lib/actions.lo ovn/lib/expr.lo \
	ovn/lib/lex.lo ovn/lib/ovn-nb-idl.lo ovn/lib/ovn-sb-idl.lo
...
am_vtep_libvtep_la_OBJECTS = vtep/vtep-idl.lo
vtep_libvtep_la_OBJECTS = $(am_vtep_libvtep_la_OBJECTS)
...
am_ovn_controller_ovn_controller_OBJECTS =  \
	...
	ovn/controller/pipeline.$(OBJEXT) \
...
am_ovn_ovn_nbctl_OBJECTS = ovn/ovn-nbctl.$(OBJEXT)
ovn_ovn_nbctl_OBJECTS = $(am_ovn_ovn_nbctl_OBJECTS)
ovn_ovn_nbctl_DEPENDENCIES = ovn/lib/libovn.la ovsdb/libovsdb.la \
	lib/libopenvswitch.la
...
am__tests_ovstest_SOURCES_DIST = tests/ovstest.c tests/ovstest.h \
	...
	tests/test-netflow.c tests/test-odp.c tests/test-ovn.c \
...
am_tests_ovstest_OBJECTS = tests/ovstest.$(OBJEXT) \
	...
	tests/test-odp.$(OBJEXT) tests/test-ovn.$(OBJEXT) \
...
SOURCES = $(lib_libopenvswitch_la_SOURCES) \
	...
	$(ovn_northd_ovn_northd_SOURCES) $(ovn_ovn_nbctl_SOURCES) \
...
am__noinst_HEADERS_DIST = appveyor.yml CONTRIBUTING.md CodingStyle.md \
	DESIGN.md FAQ.md INSTALL.md INSTALL.Debian.md \
	INSTALL.Docker.md INSTALL.DPDK.md INSTALL.Fedora.md \
	INSTALL.KVM.md INSTALL.Libvirt.md INSTALL.NetBSD.md \
	INSTALL.RHEL.md INSTALL.SSL.md INSTALL.XenServer.md \
	...
	vtep/README.ovs-vtep.md NOTICE .travis.yml .travis/build.sh \
	.travis/prepare.sh boot.sh build-aux/cccl build-aux/dist-docs \
	build-aux/sodepends.pl build-aux/soexpand.pl \
	build-aux/xml2nroff lib/common.man lib/common-syn.man \
	...
	Vagrantfile build-aux/thread-safety-blacklist \
	...
	tests/tunnel.at tests/tunnel-push-pop.at tests/lockfile.at \
	...
	tests/kmod-testsuite.at tests/kmod-macros.at \
	tests/kmod-traffic.at $(srcdir)/tests/testsuite \
	$(srcdir)/tests/kmod-testsuite tests/atlocal.in \
	...
	datapath-windows/misc/OVS.psm1 datapath-windows/ovsext.sln \
	...
	datapath-windows/ovsext/Vxlan.c datapath-windows/ovsext/Stt.h \
	datapath-windows/ovsext/Stt.c datapath-windows/ovsext/Vxlan.h \
	...
	ovn/ovn-nb.xml ovn/ovn-architecture.7.xml ovn/ovn-nbctl.8.xml \
	ovn/TODO ovn/CONTAINERS.OpenStack.md \
	ovn/controller/ovn-controller.8.xml \
	$(srcdir)/ovn/lib/ovn-sb-idl.ann \
	$(srcdir)/ovn/lib/ovn-nb-idl.ann ovn/utilities/ovn-ctl \
	ovn/utilities/ovn-ctl.8.xml include/sparse/arpa/inet.h \
...
ACLOCAL = ${SHELL} /home/ubuntu/workspace/openvswitch-2.3.2/build-aux/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/ubuntu/workspace/openvswitch-2.3.2/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/ubuntu/workspace/openvswitch-2.3.2/build-aux/missing autoheader
AUTOM4TE = ${SHELL} /home/ubuntu/workspace/openvswitch-2.3.2/build-aux/missing autom4te
AUTOMAKE = ${SHELL} /home/ubuntu/workspace/openvswitch-2.3.2/build-aux/missing automake-1.14
AWK = gawk
...
KARCH = 
KBUILD = /lib/modules/3.13.0-35-generic/build
LD = /usr/bin/ld -m elf_x86_64
LDFLAGS = 
LIBOBJS = 
LIBS = -latomic -lpthread -lrt -lm -ltcmalloc ../CM_testbed_code/public_lib/libpcap-1.7.3/libpcap.a ../CM_testbed_code/public_lib/libpublic.a
...
LT_CURRENT = 1
LT_REVISION = 0
MAKEINFO = ${SHELL} /home/ubuntu/workspace/openvswitch-2.3.2/build-aux/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MSVC_CFLAGS = 
...
PACKAGE_STRING = openvswitch 2.4.90
PACKAGE_TARNAME = openvswitch
PACKAGE_URL = 
PACKAGE_VERSION = 2.4.90
PATH_SEPARATOR = :
PERL = /usr/bin/perl
...
abs_builddir = /home/ubuntu/workspace/openvswitch-2.3.2
abs_srcdir = /home/ubuntu/workspace/openvswitch-2.3.2
abs_top_builddir = /home/ubuntu/workspace/openvswitch-2.3.2
abs_top_srcdir = /home/ubuntu/workspace/openvswitch-2.3.2
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/ubuntu/workspace/openvswitch-2.3.2/build-aux/install-sh
...
ALL_LOCAL = $(am__append_6) config-h-check printf-check static-check \
	...
	$(am__append_8) $(am__append_10) $(am__append_46) \
...
CLEANFILES = $(am__append_7) $(am__append_9) manpage-dep-check \
	...
	ofproto/ipfix-entities.def $(am__append_32) \
	$(valgrind_wrappers) $(am__append_42) include/odp-netlink.h \
	$(am__append_45) vswitchd/vswitch.ovsschema.stamp \
	vswitchd/vswitch-idl.c vswitchd/vswitch-idl.h vtep/vtep-idl.c \
	vtep/vtep-idl.h vtep/vtep.ovsschema.stamp \
	$(srcdir)/datapath-windows/include/OvsDpInterface.h \
	ovn/lib/ovn-sb-idl.c ovn/lib/ovn-sb-idl.h ovn/lib/ovn-nb-idl.c \
	ovn/lib/ovn-nb-idl.h
CLEAN_LOCAL = clean-pycov $(am__append_11) $(am__append_43)
DISTCLEANFILES = utilities/ovs-appctl.8 utilities/ovs-ctl \
	...
	vswitchd/ovs-vswitchd.8 $(am__append_47) \
	vswitchd/ovs-vswitchd.conf.db.5 ovsdb/ovsdb-tool.1 \
	ovsdb/ovsdb-client.1 ovsdb/ovsdb-server.1 ovsdb/ovsdb-idlc \
	ovsdb/ovsdb-dot vtep/vtep-ctl.8 $(am__append_48) vtep/vtep.5 \
	$(am__append_49) ovn/ovn-sb.5 $(am__append_50) ovn/ovn-nb.5 \
	ovn/ovn-nbctl.8 ovn/ovn-architecture.7 \
	ovn/controller/ovn-controller.8 ovn/utilities/ovn-ctl.8
...
docs = appveyor.yml CONTRIBUTING.md CodingStyle.md DESIGN.md FAQ.md \
	INSTALL.md INSTALL.Debian.md INSTALL.Docker.md INSTALL.DPDK.md \
	INSTALL.Fedora.md INSTALL.KVM.md INSTALL.Libvirt.md \
	INSTALL.NetBSD.md INSTALL.RHEL.md INSTALL.SSL.md \
	INSTALL.XenServer.md INSTALL.userspace.md INSTALL.Windows.md \
	IntegrationGuide.md OPENFLOW-1.1+.md PORTING.md README.md \
...
EXTRA_DIST = $(docs) NOTICE .travis.yml .travis/build.sh \
	...
	$(TESTSUITE_AT) $(KMOD_TESTSUITE_AT) $(TESTSUITE) \
	$(KMOD_TESTSUITE) tests/atlocal.in $(srcdir)/package.m4 \
...
# ovsdb-client.1
# ovsdb-server.1
man_MANS = utilities/ovs-sim.1 utilities/ovs-appctl.8 \
	utilities/ovs-benchmark.1 utilities/ovs-ctl.8 \
	utilities/ovs-testcontroller.8 utilities/ovs-dpctl.8 \
...
OVSIDL_BUILT = lib/vswitch-idl.c lib/vswitch-idl.h \
	...
	vtep/vtep-idl.ovsidl $(srcdir)/ovn/lib/ovn-sb-idl.c \
	$(srcdir)/ovn/lib/ovn-sb-idl.h \
	$(srcdir)/ovn/lib/ovn-sb-idl.ovsidl \
	$(srcdir)/ovn/lib/ovn-nb-idl.c $(srcdir)/ovn/lib/ovn-nb-idl.h \
...
SUFFIXES = .in .xml $(am__append_44) .ovsidl .ovsschema
check_DATA = $(am__append_41)
...
lib_libopenvswitch_la_LIBADD = $(SSL_LIBS) $(am__append_12)
...
nodist_lib_libopenvswitch_la_SOURCES = lib/dirs.c $(am__append_25)
...
lib/tnl-arp-cache.lo: lib/$(am__dirstamp) \
	lib/$(DEPDIR)/$(am__dirstamp)
...
lib/cm/$(am__dirstamp):
	@$(MKDIR_P) lib/cm
	@: > lib/cm/$(am__dirstamp)
lib/cm/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) lib/cm/$(DEPDIR)
	@: > lib/cm/$(DEPDIR)/$(am__dirstamp)
lib/cm/data_warehouse.lo: lib/cm/$(am__dirstamp) \
	lib/cm/$(DEPDIR)/$(am__dirstamp)
lib/cm/interval_rotator.lo: lib/cm/$(am__dirstamp) \
	lib/cm/$(DEPDIR)/$(am__dirstamp)
lib/cm/mt_hashtable_kFlowSrc_vInt_fixSize.lo: lib/cm/$(am__dirstamp) \
	lib/cm/$(DEPDIR)/$(am__dirstamp)
lib/cm/packet_processor.lo: lib/cm/$(am__dirstamp) \
	lib/cm/$(DEPDIR)/$(am__dirstamp)
lib/cm/cm_output.lo: lib/cm/$(am__dirstamp) \
	lib/cm/$(DEPDIR)/$(am__dirstamp)
lib/cm/condition_rotator.lo: lib/cm/$(am__dirstamp) \
	lib/cm/$(DEPDIR)/$(am__dirstamp)
...
ovn/controller/ovn-controller.$(OBJEXT):  \
	ovn/controller/$(am__dirstamp) \
	ovn/controller/$(DEPDIR)/$(am__dirstamp)
ovn/controller/pipeline.$(OBJEXT): ovn/controller/$(am__dirstamp) \
	ovn/controller/$(DEPDIR)/$(am__dirstamp)
...
ovn/$(am__dirstamp):
	@$(MKDIR_P) ovn
	@: > ovn/$(am__dirstamp)
ovn/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) ovn/$(DEPDIR)
	@: > ovn/$(DEPDIR)/$(am__dirstamp)
ovn/ovn-nbctl.$(OBJEXT): ovn/$(am__dirstamp) \
	ovn/$(DEPDIR)/$(am__dirstamp)

ovn/ovn-nbctl$(EXEEXT): $(ovn_ovn_nbctl_OBJECTS) $(ovn_ovn_nbctl_DEPENDENCIES) $(EXTRA_ovn_ovn_nbctl_DEPENDENCIES) ovn/$(am__dirstamp)
	@rm -f ovn/ovn-nbctl$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(ovn_ovn_nbctl_OBJECTS) $(ovn_ovn_nbctl_LDADD) $(LIBS)
...
include lib/$(DEPDIR)/tnl-arp-cache.Plo
...
include lib/cm/$(DEPDIR)/cm_output.Plo
include lib/cm/$(DEPDIR)/condition_rotator.Plo
include lib/cm/$(DEPDIR)/data_warehouse.Plo
include lib/cm/$(DEPDIR)/interval_rotator.Plo
include lib/cm/$(DEPDIR)/mt_hashtable_kFlowSrc_vInt_fixSize.Plo
include lib/cm/$(DEPDIR)/packet_processor.Plo
...
include ovn/$(DEPDIR)/ovn-nbctl.Po
...
include ovn/controller/$(DEPDIR)/pipeline.Po
...
distclean: distclean-recursive
	...
	-rm -rf lib/$(DEPDIR) lib/cm/$(DEPDIR) lib/lldp/$(DEPDIR) ofproto/$(DEPDIR) ovn/$(DEPDIR) ovn/controller/$(DEPDIR) ovn/lib/$(DEPDIR) ovn/northd/$(DEPDIR) ovsdb/$(DEPDIR) tests/$(DEPDIR) tests/dpdk/$(DEPDIR) utilities/$(DEPDIR) vswitchd/$(DEPDIR) vtep/$(DEPDIR)
	-rm -f Makefile
